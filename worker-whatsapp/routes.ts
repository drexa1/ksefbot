...
import {verificationHandler, messageHandler, test, } from "./routes/whatsapp";
...
export const routes: Record<string, Routes> =  {
    ...
    "/privacy":           { GET: async (_request, env) => env.KSEFBOT_ASSETS.fetch(new Request(`${env.KSEFBOT_ASSETS_URL}/privacy`)) },
